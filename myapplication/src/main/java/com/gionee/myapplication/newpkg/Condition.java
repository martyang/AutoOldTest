...
public class Condition {
    public static void set(Context context) {
        ...
        addToSoftWareManagerWhiteLIst(context, pkgName);
    ...
    public static void addToSoftWareManagerWhiteLIst(Context mContext, String pkgName) {
    ...
    public static void setRotateOn(Context context, boolean isOpen) {
        Settings.System.putInt(context.getContentResolver(), Settings.System.ACCELEROMETER_ROTATION, isOpen ? 1 : 0);
    }
...
//            Util.i("oneclean" + cursor.getCount() + "");
    ...
    public static void removeFromWhileList(Context context, String pkgName) {
        if (isInWhiteList(context, pkgName)) {
            context.getContentResolver().delete(ROSTER_CONTENT_URI, "usertype='oneclean' AND packagename='" + pkgName + "'", null);
        }
    }
